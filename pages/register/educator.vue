        ...
        <v-row>
          <v-col cols="12" md="6" class="d-flex flex-column justify-center">
            ...
            <div class="text-h6 font-weight-medium mt-2">
              <span class="darkgrey--text">Welcome to the EDCOM HQ Jobs platform! <b>Fill out the form below</b> to register as an educator</span>
            </div>
  ...
  export default {
    ...
    methods: {
      ...
      async register() {
        ...
        return fetch(this.$config.EDCOM_HQ_JOBS_API_BASE_URL + '/educator/register', {
          method: 'POST',
